    ...
    if user_id in USER_STATES and USER_STATES[user_id] == "waiting_for_email":
        ...
        if "@" in email and "." in email and len(email) > 5:
            ...
            payment_msg = (
                ...
                "1️⃣ Вступи в чат ,где мы общаемся: @https://t.me/+BzRGEXhUe2VjNzNi\n"
                "2️⃣ Активируй чат с Полиной: @@polinakaulkina\n\n"
...
async def handle_message(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if user_id in USER_STATES and USER_STATES[user_id] == "waiting_for_email":
        ...
        if text == "/start":
            ...
            await update.message.reply_text(
                "Я не понял ваше сообщение. Используйте меню слева от поля ввода."
            )
